...
export const Input = forwardRef(({ error, title, help, className, ...rest }: InputProps, ref: Ref<HTMLInputElement>) => {
  return (
    <div className="flex flex-col gap-2">
      {title && <span className="px-1 text-lg font-medium">Email address</span>}
      <div>
        <input
          ref={ref}
